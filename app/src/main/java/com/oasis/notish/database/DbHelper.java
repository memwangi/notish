package com.oasis.notish.database;
...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public long insertNote(String note) {
        ...
        //id and timestamp will be added automatically no need to add them
    ...
    public List<Note> getAllNotes(){
        ...
        //Looping through rows and adding to a list
    ...
    //Deleting a note requires deleting a note by finding its 'id'. It also requires writable access
